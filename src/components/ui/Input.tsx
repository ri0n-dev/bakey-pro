  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-neutral-950 focus-visible:ring-neutral-950/50 focus-visible:ring-[1px] dark:focus-visible:border-neutral-300 dark:focus-visible:ring-neutral-300/50",
