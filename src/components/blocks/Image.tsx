...
export const Image: React.FC<{ title: string; redirect: string; icon: React.ReactNode; }> = ({ title, redirect, icon }) => {
    return (
...
export const ImageAdmin: React.FC<{ content: any[]; redirect: string; id: string; handleSave: (id: string, changes: Partial<Block>) => void; handleDelete: (id: string) => void; }> = ({ content, redirect, id, handleSave, handleDelete }) => {
